 ...
 *          running,  the format was unsupported, or the width or height were out
 *          of range.
 *
...
/**
 *  \brief Set the color used for drawing operations (Rectangle, Line and Clear).
 *
...
/**
 *  \brief Get the color used for drawing operations (Rectangle, Line and Clear).
 *
